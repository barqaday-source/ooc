...
// يعرض قائمة المحادثات بآخر رسالة + شارة عدّاد رسائل غير مقروءة (كانستغرام)
// ====================================================================
            ...
            <div className="space-y-2.5">
              {filtered.map((r) => {
                ...
                return (
                  <div
                    key={r.room.id}
                    className="w-full flex items-center gap-3 p-2.5 rounded-[1.5rem] hover:bg-background/40 transition text-right"
                  >
                    ...
                    {unread > 0 && (
                      <span className="min-w-[20px] h-[20px] px-1.5 rounded-full bg-destructive text-destructive-foreground text-[10px] font-bold flex items-center justify-center shrink-0 ring-2 ring-card animate-pulse">
                        {unread > 99 ? "99+" : unread}
                      </span>
                    )}
                  </div>
